...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    className={cn(
      ...
      "data-[state=open]:animate-[overlay-show_150ms_ease-out]",
      "data-[state=closed]:animate-[overlay-hide_120ms_ease-in]",
      className
    )}
    {...props}
  />
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "data-[state=open]:animate-[content-show_150ms_ease-out]",
        "data-[state=closed]:animate-[content-hide_120ms_ease-in]",
        "focus:outline-none",
        className
      )}
      {...props}
