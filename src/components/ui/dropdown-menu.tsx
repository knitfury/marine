...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-32 overflow-hidden rounded-md border border-border bg-surface-raised p-1 shadow-lg",
      "data-[state=open]:animate-[menu-pop_120ms_ease-out]",
      className
    )}
    {...props}
  />
...
>(({ className, inset, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      destructive ? "text-danger focus:bg-danger-subtle focus:text-danger-subtle-foreground" : "text-foreground",
      inset && "pl-8",
      className
    )}
    {...props}
